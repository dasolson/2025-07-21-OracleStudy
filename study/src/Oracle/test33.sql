...
/*
      1. IN       => 일반 대입값 : INSERT / UPDATE / DELETE
      2. OUT    => 결과값을 받는 경우에 사용 : SELECT 
      3. INOUT => 일반 대입값, 결과값 처리 : SELECT
         --------
          IN변수는 WHERE 뒤에, OUT 변수는 값을 읽어오는 변수
         *** 생략된 경우는 IN변수로 인식
      ...
      형식)
                ...
                IS
                   변수 설정
                BEGIN
                   구현부 : SELECT / INSERT / UPDATE / DELETE
                END;
                /               
