...
/*
 *     람다식 : 함수명이 존재하지 않는다
 *            ------------------ 익명의 함수를 이용해서 간단하게 표현하는 문법
 *                                  () -> {구현부} => 함수명(x), return(x)
 *                                  
 *                                  let aaa=()=>{} => Function / return 생략
 *       함수형 인터페이스를 만드는 경우 : 구현이 안된 메소드 1개가 필요하다
 *        => 코드가 간결하다 / 가독성 (여러개 사용) 떨어진다
 *        => 기존 라이브러리 함수 구현
 *                                         
 */
public class 람다_1 {
